...
$webRoot  = str_replace(array($docRoot, 'assets/php/config.php'), '', $thisFile);
$srvRoot  = str_replace('assets/php/config.php', '', $thisFile);
...
define('SRV_ROOT', $srvRoot);
	...
	class Database {
		...
		const USERNAME = 'agent27037@gmail.com';
		const PASSWORD = 'Ilovemygmail';

		
		private $dsn = "mysql:host=localhost;dbname=studio";
		private $dbuser = "root";
		private $dbpass = "";

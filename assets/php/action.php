	...
	if (isset($_POST['action']) && $_POST['action'] == 'forgot') {
		...
		if ($user_found != null) {
			...
			try {
                ...
                $mail->Body = '<h3>Click the below link to reset your password.</h3><br><a href="http://ideagraphy.lk/reset-password.php?email='.$email.'&token='.$token.'">http://ideagraphy.lk/reset-password.php?email='.$email.'&token='.$token.'</a><br><br><br>Regards,<br>Ideagraphy Studio';

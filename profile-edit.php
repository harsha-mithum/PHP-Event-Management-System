...
if (isset($_POST['image'])) {
	...
	$newImage = $image_name;
	move_uploaded_file($_POST['image']['tmp_name'], $newImage);
...
<div class="page-wrapper m-0 bg-white">
	<!-- Page Header -->
	<div class="page-header bg-white mt-2">
		<div class="container">
									...
									<form action="#" id="change-pass-form">
										<div class="form-group">
											...
											<div class="text-right">
												<small class="forgotpass"><a href="#" id="forgot-link" data-toggle="modal" data-target="#forgotPassModal">Forgot your password?</a></small>
											</div>
										</div>
										<div class="form-group">
							...
							<div class="card-body">
								...
								<form action="" id="delete-form">
									<div class="form-group">
										...
										<input type="password" class="form-control" id="inputPasswordCurrent" name="curpass">
										<div class="text-right">
											<small><a href="#" data-toggle="modal" data-target="#forgotPassModal">Forgot your password?</a></small>
										</div>
									</div>
									<p><strong>This will permanently delete your account and not be able to log in again.</strong> </p>
									<div class="text-right">
										<button type="submit" class="btn btn-danger" name="delete_account" id="delete-btn">Delete Account&nbsp;<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true" style="display: none;" id="delete-spinner"></span></button>
									</div>
								</form>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button class="btn btn-primary" type="submit" id="forgot-btn">Reset Passowrd&nbsp;
